$(function () {
    ...
    function get_code() {        
        $.ajax({
            url: "manufacture_code",
            type: "GET",
            dataType: "JSON",
            success: function (data) {
                $("#mf_code").val(data.code)
            },
    ...
    $(document).on('click', '#edit_dept', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#action_stat').val('update');
                $('[name="id"]').val(data.id);
                $('[name="mf_code"]').val(data.manufacture_code);
                $('[name="mf"]').val(data.manufacture);
            },
            error: function (jqXHR, textStatus, errorThrown) {

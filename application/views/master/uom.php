        ...
        <div class="card-box">
            <div class="row">
                    ...
                    <form id="form">
                        <fieldset class="form-group">
                            ...
                            <div class="form-group row ">
                                <label for="uom_code" class="col-4 col-form-label">Code *</label>
                                <div class="col-8">
                                    <input class="form-control form-control-sm" type="text" name="uom_code" id="uom_code" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="uom" class="col-4 col-form-label">Uom*</label>
                                <div class="col-8">
                                    <input class="form-control form-control-sm" type="text" name="uom" id="uom">
                                </div>
                            </div>
                ...
                <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-8">
                    <fieldset class="form-group">
                        <table id="uom_table" class="table table-bordered table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            <thead>
                                <tr>

        ...
        <div class="card-box">
            <div class="row">
                    ...
                    <form id="form">
                        <fieldset class="form-group">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-8">
                                    <input class="form-control form-control-sm" type="text" name="dept_code" id="dept_code" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                ...
                <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-8">
                    <fieldset class="form-group">
                        <table id="table_dept" class="table table-bordered table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            <thead>
                                <tr>

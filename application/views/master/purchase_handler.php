                    ...
                    <form id="form">
                        <fieldset class="form-group">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-8">
                                    <input class="form-control" type="text" name="ph_code" id="ph_code" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="dept" class="col-4 col-form-label">Purchase Handler*</label>
                                <div class="col-8">
                                    <input class="form-control" type="text" name="ph_handler" id="ph_handler">
                                </div>
                            </div>
